...
<header class="sticky-top">
	<nav class="navbar navbar-expand-xl navbar-dark bg-darker">
		<Link class="navbar-brand" to="/backoffice/projects"><img class="h-50px d-none d-sm-block" src="/../imgs/esl.png" alt="Logo ESL"></Link>
		<ul class="navbar-nav mr-2 ml-auto flex-row">
		    {#if is_logged_in}
